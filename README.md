...
- The blockchain app contains three types of tokens: Nash, Bond, and Share.
  ...
  - Share: There is a reserve of ‘LSK’ coins to make the system more sustainable under complex conditions. Any user can invest in the reserve in exchange for Share tokens. A portion of generated Nash tokens in high prices will be distributed among the shareholders.
