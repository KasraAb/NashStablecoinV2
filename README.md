...
- The blockchain app contains three types of tokens: Nash, Bond, and Share.
  ...
  - Bond: Non-fungible tokens resealed when the price is under the pegg. These are only purchasable by Nash tokens. When the price goes higher than the pegg, these tokens will be automatically turned into Nash tokens. 
